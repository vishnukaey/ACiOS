...
- (void)initialUISetUp
{
  NSString * infoText = @"You are reporting this opportunity because it may contain content that is offensive or objectionable.\n\nThe opportunity could be removed from ThatHelps if the content is deemed to be offensive or objectionable.\n\nThe Admins have the final say on all content and posts on the ThatHelps network";
