...
- (void)initialSetUp
{
  ...
  self.noResultsView = [LCUtilityManager getNoResultViewWithText:NSLocalizedString(@"no_interests_available_self", nil) andViewWidth:CGRectGetWidth(self.tableView.frame)];
