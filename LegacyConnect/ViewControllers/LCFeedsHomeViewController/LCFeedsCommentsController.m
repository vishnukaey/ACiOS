...
@interface LCFeedsCommentsController ()
...
-(void)prepareCells
{
        NSDictionary *postDetail = [[NSDictionary alloc]initWithObjectsAndKeys:@"Json Rogers",@"user_name",   @"1",@"type",     @"Global Employment",@"cause",  @"15 minutes ago",@"time",   @"Can't wait to run in Haiti for TeamTassy, stay tuned for details!",@"post",   @"",@"image_url",  @"0",@"favourite",   @"8",@"thanks",  @"2",@"comments",  nil];//post data
    ...
    float in_margin = 10;
        for (int i=0; i<commentsArray.count; i++) {
            ...
            NSString *dp_data = [[commentsArray objectAtIndex:i] valueForKey:@"profile_pic"];
